...
const SCALE = 10n ** 9n;
const solAmt = (whole: number): string => (BigInt(whole) * SCALE).toString();
...
function makeMarket(label: string, over: Partial<MarketDto> & Pick<MarketDto, "address" | "oracle" | "status" | "statusLabel">): MarketDto {
  const base: MarketDto = {
    ...
    minLiquidity: solAmt(500_000),
    totalContributed: solAmt(0),
    openContributions: 1,
    bump: 253,
    escrowBump: 252,
    outcomeIndex: 0,
    ...
    lpVault: ZERO,
    lpTotal: solAmt(0),
    activationLp: solAmt(0),
    activationContributed: solAmt(0),
    grossLpTotal: solAmt(0),
    slot: "1000",
  };
  return { ...base, ...over };
}
...
function makeContribution(
  ...
  return {
    ...
    amount: solAmt(amountWhole),
    claimed: opts.claimed ?? false,
    bump: 254,
    lateLp: solAmt(opts.lateLpWhole ?? 0),
    slot: opts.slot ?? "1000",
  };
}
...
const HAND_FIXTURES: MarketFixture[] = [
  {
    ...
    dto: makeMarket("funding", {
      ...
      status: 0 /* Funding */,
      statusLabel: "Funding",
      totalContributed: solAmt(235_000),
      openContributions: 2,
      slot: "1001",
    }),
  ...
  },
  {
    ...
    dto: makeMarket("funded", {
      ...
      status: 0 /* Funding */,
      statusLabel: "Funding",
      totalContributed: solAmt(650_000),
      openContributions: 2,
      slot: "1003",
    }),
  ...
  },
  {
    ...
    dto: makeMarket("active", {
      ...
      status: 1 /* Active */,
      statusLabel: "Active",
      totalContributed: solAmt(620_000),
      openContributions: 2,
      ...
      lpTotal: solAmt(640_000),
      activationLp: solAmt(620_000),
      activationContributed: solAmt(620_000),
      grossLpTotal: solAmt(640_000),
      slot: "1010",
    }),
    oracle: ORACLES[O_ACTIVE],
    reserves: { base: solAmt(600_000), quote: solAmt(400_000) },
    contributions: [
  ...
  },
  {
    ...
    dto: makeMarket("resolved", {
      ...
      totalContributed: solAmt(500_000),
      openContributions: 1,
      feeCollected: 1,
      settled: 1,
      ...
      lpTotal: solAmt(500_000),
      activationLp: solAmt(500_000),
      activationContributed: solAmt(500_000),
      grossLpTotal: solAmt(500_000),
      slot: "1020",
    }),
  ...
  },
  {
    ...
    dto: makeMarket("resolved-no", {
      ...
      status: 2 /* Resolved */,
      statusLabel: "Resolved",
      totalContributed: solAmt(540_000),
      openContributions: 1,
      feeCollected: 1,
      settled: 1,
      ...
      lpTotal: solAmt(540_000),
      activationLp: solAmt(540_000),
      activationContributed: solAmt(540_000),
      grossLpTotal: solAmt(540_000),
      slot: "1021",
    }),
  ...
  },
  {
    ...
    dto: makeMarket("void", {
      ...
      status: 3 /* Void */,
      statusLabel: "Void",
      totalContributed: solAmt(480_000),
      openContributions: 1,
      feeBps: 0,
      ...
      lpTotal: solAmt(480_000),
      activationLp: solAmt(480_000),
      activationContributed: solAmt(480_000),
      grossLpTotal: solAmt(480_000),
      slot: "1030",
    }),
  ...
  },
  {
    ...
    dto: makeMarket("cancelled", {
      ...
      totalContributed: solAmt(150_000),
      openContributions: 2,
      slot: "1004",
    }),
  ...
  },
  {
    ...
    dto: makeMarket("cat0", {
      ...
      statusLabel: "Resolved",
      outcomeIndex: 0,
      totalContributed: solAmt(300_000),
      openContributions: 1,
      feeCollected: 1,
      settled: 1,
      ...
      lpTotal: solAmt(300_000),
      activationLp: solAmt(300_000),
      activationContributed: solAmt(300_000),
      grossLpTotal: solAmt(300_000),
      slot: "1040",
    }),
  ...
  },
  {
    ...
    dto: makeMarket("cat1", {
      ...
      statusLabel: "Active",
      outcomeIndex: 1,
      totalContributed: solAmt(250_000),
      openContributions: 1,
      ...
      lpTotal: solAmt(250_000),
      activationLp: solAmt(250_000),
      activationContributed: solAmt(250_000),
      grossLpTotal: solAmt(250_000),
      slot: "1036",
    }),
    oracle: ORACLES[O_CATEGORICAL],
    reserves: { base: solAmt(350_000), quote: solAmt(150_000) },
  ...
  },
  {
    ...
    dto: makeMarket("cat2", {
      ...
      statusLabel: "Resolved",
      outcomeIndex: 2,
      totalContributed: solAmt(200_000),
      openContributions: 1,
      feeCollected: 1,
      settled: 1,
      ...
      lpTotal: solAmt(200_000),
      activationLp: solAmt(200_000),
      activationContributed: solAmt(200_000),
      grossLpTotal: solAmt(200_000),
      slot: "1041",
    }),
    oracle: ORACLES[O_CATEGORICAL],
    reserves: null,
  ...
  },
  {
    ...
    dto: makeMarket("cat-funding-1", {
      ...
      statusLabel: "Funding",
      outcomeIndex: 1,
      totalContributed: solAmt(80_000),
      openContributions: 1,
      slot: "1051",
    }),
    oracle: ORACLES[O_CATEGORICAL_FUNDING],
  ...
  },
  {
    ...
    dto: makeMarket("cat-funding-2", {
      ...
      statusLabel: "Funding",
      outcomeIndex: 2,
      totalContributed: solAmt(120_000),
      openContributions: 1,
      slot: "1052",
    }),
    oracle: ORACLES[O_CATEGORICAL_FUNDING],
  ...
  },
  {
    ...
    dto: makeMarket("cat-funded-0", {
      ...
      statusLabel: "Funding",
      outcomeIndex: 0,
      totalContributed: solAmt(560_000),
      openContributions: 1,
      slot: "1060",
    }),
  ...
  },
  {
    ...
    dto: makeMarket("cat-funded-1", {
      ...
      statusLabel: "Funding",
      outcomeIndex: 1,
      totalContributed: solAmt(510_000),
      openContributions: 1,
      slot: "1061",
    }),
    oracle: ORACLES[O_CATEGORICAL_FUNDED],
  ...
  },
  {
    ...
    dto: makeMarket("cat-funded-2", {
      ...
      statusLabel: "Funding",
      outcomeIndex: 2,
      totalContributed: solAmt(700_000),
      openContributions: 1,
      slot: "1062",
    }),
    oracle: ORACLES[O_CATEGORICAL_FUNDED],
  ...
  },
  {
    ...
    dto: makeMarket("cat-active-0", {
      ...
      statusLabel: "Active",
      outcomeIndex: 0,
      totalContributed: solAmt(520_000),
      openContributions: 1,
      ...
      lpTotal: solAmt(520_000),
      activationLp: solAmt(520_000),
      activationContributed: solAmt(520_000),
      grossLpTotal: solAmt(520_000),
      slot: "1070",
    }),
    oracle: ORACLES[O_CATEGORICAL_ACTIVE],
    reserves: { base: solAmt(300_000), quote: solAmt(220_000) },
  ...
  },
  {
    ...
    oracle: ORACLES[O_CATEGORICAL_ACTIVE],
    reserves: { base: solAmt(180_000), quote: solAmt(320_000) },
  ...
  },
  {
    ...
    oracle: ORACLES[O_CATEGORICAL_ACTIVE],
    reserves: { base: solAmt(260_000), quote: solAmt(280_000) },
  ...
  },
  {
    ...
    dto: makeMarket("cat-void-0", {
      ...
      lpTotal: solAmt(510_000),
      activationLp: solAmt(510_000),
      activationContributed: solAmt(510_000),
      grossLpTotal: solAmt(510_000),
      slot: "1080",
    }),
  ...
  },
  {
    ...
    dto: makeMarket("cat-void-1", {
      ...
      statusLabel: "Void",
      outcomeIndex: 1,
      totalContributed: solAmt(505_000),
      openContributions: 1,
      feeBps: 0,
      feeCollected: 1,
      settled: 1,
      ...
      lpTotal: solAmt(505_000),
      activationLp: solAmt(505_000),
      activationContributed: solAmt(505_000),
      grossLpTotal: solAmt(505_000),
      slot: "1081",
    }),
    oracle: ORACLES[O_CATEGORICAL_VOID],
    reserves: null,
  ...
  },
  {
    ...
    dto: makeMarket("cat-void-2", {
      ...
      statusLabel: "Void",
      outcomeIndex: 2,
      totalContributed: solAmt(515_000),
      openContributions: 1,
      feeBps: 0,
      feeCollected: 1,
      settled: 1,
      ...
      lpTotal: solAmt(515_000),
      activationLp: solAmt(515_000),
      activationContributed: solAmt(515_000),
      grossLpTotal: solAmt(515_000),
      slot: "1082",
    }),
    oracle: ORACLES[O_CATEGORICAL_VOID],
    reserves: null,
  ...
  },
  {
    ...
    dto: makeMarket("cat-cancelled-0", {
      ...
      statusLabel: "Cancelled",
      outcomeIndex: 0,
      totalContributed: solAmt(60_000),
      openContributions: 1,
      slot: "1090",
    }),
  ...
  },
  {
    ...
    dto: makeMarket("cat-cancelled-1", {
      ...
      statusLabel: "Cancelled",
      outcomeIndex: 1,
      totalContributed: solAmt(45_000),
      openContributions: 1,
      slot: "1091",
    }),
    oracle: ORACLES[O_CATEGORICAL_CANCELLED],
  ...
  },
  {
    ...
    dto: makeMarket("cat-cancelled-2", {
      ...
      statusLabel: "Cancelled",
      outcomeIndex: 2,
      totalContributed: solAmt(70_000),
      openContributions: 1,
      slot: "1092",
    }),
    oracle: ORACLES[O_CATEGORICAL_CANCELLED],
  ...
  return Array.from({ length: 9 }, (_, i) => {
    ...
    return {
      dto: makeMarket(`cat9-funding-${i}`, {
        ...
        statusLabel: "Funding",
        outcomeIndex: i,
        totalContributed: solAmt(contributedWhole),
        openContributions: 1,
        slot,
      }),
  ...
  return Array.from({ length: 9 }, (_, i) => {
    ...
    return {
      dto: makeMarket(`cat9-resolved-${i}`, {
        ...
        lpTotal: solAmt(contributedWhole),
        activationLp: solAmt(contributedWhole),
        activationContributed: solAmt(contributedWhole),
        grossLpTotal: solAmt(contributedWhole),
        slot,
      }),
      ...
      reserves: pending ? { base: solAmt(240_000), quote: solAmt(260_000) } : null,
...
export function mockConfigDto(): ConfigDto {
  const minLiquidity = solAmt(500_000);
  return {
