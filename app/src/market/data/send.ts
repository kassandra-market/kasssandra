 ...
 */
async function relayAndConfirm(indexer: IndexerClient, relay: () => Promise<string>): Promise<SendResult> {
 ...
 */
export async function sendSignedAndConfirm(indexer: IndexerClient, tx: Transaction): Promise<SendResult> {
