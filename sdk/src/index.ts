/**
 * `@kassandra/sdk` — the public entry point.
 *
 ...
 *  - **instruction builders** — all 22 builders + their `*Args` param types, plus
...
// The 22 instruction builders, their `*Args` param types, + payload helpers.
