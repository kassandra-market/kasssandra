/**
 * Instruction builder unit tests (no chain).
 *
 ...
 *
 * The decoder tests (Config/Market/Contribution byte layouts + `assertAccount`)
 * live in the sibling `decoders.test.ts`; shared fixtures live in
 * `helpers/builders.ts`.
 */
