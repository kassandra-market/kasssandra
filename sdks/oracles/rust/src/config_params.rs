...
use kassandra_oracles_program::config::{
    ...
    CHALLENGE_SUCCESS_BASE_FEE_NUM, FEE_EMA_HALFLIFE_SECS, FEE_EMA_INCREMENT, FEE_PER_EMA_UNIT,
...
impl ConfigParams {
    ...
    pub fn defaults() -> Self {
        Self {
            ...
            challenge_success_base_fee_num: CHALLENGE_SUCCESS_BASE_FEE_NUM,
            challenge_success_base_fee_den: CHALLENGE_SUCCESS_BASE_FEE_DEN,
    ...
    pub fn to_payload(self) -> [u8; 200] {
        ...
        let fields: [[u8; 8]; 25] = [
            ...
            self.challenge_success_base_fee_num.to_le_bytes(),
            self.challenge_success_base_fee_den.to_le_bytes(),
...
mod tests {
    ...
    fn to_payload_is_200_bytes_le_in_field_order() {
        ...
        let p = ConfigParams {
            ...
            challenge_success_base_fee_num: 21,
            challenge_success_base_fee_den: 22,
