...
| `AiClaim` | `request_ai_oracle` (28), `apply_external_ai_claim` (29), `finalize_ai_claims` (8) |
...
`set_governance` (13), `set_config` (14), and `spot_price` (16) act on the Protocol singleton or
