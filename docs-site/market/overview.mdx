...
description: "A SOL-denominated AMM prediction market on Solana — a thin Pinocchio wrapper over MetaDAO's v0.4 conditional vault + AMM that defers resolution to the Kassandra oracle."
---

**Kassandra Market** is a SOL-denominated AMM prediction market on Solana. Anyone
...
the oracle resolves, the market settles, a protocol fee is cut to the SOL
...
`programs/markets/`, and is deployed under program ID
`FEGNHWAB7kc7VC9CCwbvVPsv4Jykz2r2WQ758V4xCT9S` (`programs/markets/src/lib.rs:17`).
...
<Steps>
  <Step title="Create + crowdfund (Funding)">
    A creator seeds any amount of SOL, even below the floor; anyone contributes
...
<CardGroup cols={2}>
  ...
  <Card title="SDK" icon="scroll" href="/sdk/market">
    The `@kassandra-market/markets` TypeScript client.
  </Card>
</CardGroup>
